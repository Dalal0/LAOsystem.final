...
<div class="container">
	<h1 class="page-header text-center">MAKE ORDER</h1>	
	<form method="POST" action="purchase.php">
				...
				<?php 
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td class="text-right">SAR <?php echo number_format($row['price'], 2); ?></td>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<input type="text" name="AppName" class="form-control" placeholder="App Name" required>
			</div>
